...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        "flex min-h-8 flex-wrap items-center gap-1 rounded-2xl border border-transparent bg-input/50 bg-clip-padding px-2.5 py-1 text-sm transition-[color,box-shadow] duration-200 focus-within:border-ring focus-within:ring-0 has-aria-invalid:border-destructive has-aria-invalid:ring-0 has-data-[slot=combobox-chip]:px-1 dark:has-aria-invalid:border-destructive/50",
        className
      )}
      {...props}
    />
